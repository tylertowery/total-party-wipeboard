    ...
    <div className="page">
      ...
      <div className='main'>
        ...
        <div className='create-container'>
          {auth.currentUser
            ?
            <button className='create-party-button' onClick={handleParty}>Click Here To Create A New Party</button>
            :
            <button className='create-user-button' onClick={handleCreate}>Click Here To Create An Account Now</button>
          }
        </div>
      </div>
    </div>
